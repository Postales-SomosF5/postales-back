...
def create_app():
    ...
    # === 2. Inicializar extensiones INMEDIATAMENTE después de la configuración ===
    db.init_app(app)
    bcrypt.init_app(app)
    mail.init_app(app)
    jwt.init_app(app)
    ...
    # === 6. Crear tablas (después de inicializar db y cargar modelos) ===
